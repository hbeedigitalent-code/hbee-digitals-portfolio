...
export async function sendConditionallyApprovedEmail(data: EmailData) {
  const html = `
<!DOCTYPE html>
<html>
<head>
  ...
  <title>Review Completed - Hbee Digitals</title>
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .badge { display: inline-block; background: #FBBF24; color: #07111F; padding: 6px 18px; border-radius: 9999px; font-size: 12px; font-weight: 700; text-transform: uppercase; letter-spacing: 0.06em; margin-top: 12px; }
    ...
    .signoff { margin-top: 24px; padding: 20px 24px; background: #f8fafc; border-radius: 12px; border-left: 4px solid #FBBF24; }
    ...
    @media (prefers-color-scheme: dark) {
      ...
      .journey-line.done { background: #39D97A; }
      .signoff { background: #07111F; border-left-color: #FBBF24; }
...
<body>
  <div class="email-wrapper">
    <div class="email-container">
      ...
      <div class="email-content">
        <h1>Your Growth Review Has Been Completed</h1>
        <p>Hi <strong>${data.firstName}</strong>,</p>
        <p>We've now completed the review of your business.</p>
        <p>At this stage, we've identified several opportunities that would benefit from further discussion before determining eligibility for our current <strong>Q3 Growth Support Implementation Initiative</strong>.</p>
        <p><strong>This doesn't mean your business has been declined.</strong></p>
        <p><strong>It simply means we'd like to better understand certain aspects of your business before making a final recommendation.</strong></p>
        <div class="journey-tracker">
          ...
          <div class="journey-steps">
            ...
            <span class="journey-line done"></span>
            <span class="journey-step active"><span class="icon">●</span> Discussion</span>
        ...
        <p>If you're happy to continue, we'd like to schedule a brief discussion to walk through our findings and answer any questions you may have.</p>
        <p style="text-align: center; margin: 24px 0;">
          <a href="${data.bookUrl}" class="btn-primary">Book Consultation</a>
        </p>
        <div class="signoff">
  ...
  try {
    ...
    console.log('✅ Conditionally approved email sent to:', data.email)
  } catch (error) {
    console.error('Error sending conditionally approved email:', error)
  }
}