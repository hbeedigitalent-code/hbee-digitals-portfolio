...
export async function sendApprovedGrowthSupportEmail(data: EmailData) {
  const html = `
<!DOCTYPE html>
<html>
<head>
  ...
  <title>Approved - Hbee Digitals</title>
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .benefits { background: #f8fafc; border: 1px solid #e2e8f0; border-radius: 16px; padding: 20px 24px; margin: 20px 0; }
    .benefits li { padding: 6px 0; color: #475569; list-style: none; }
    .benefits li::before { content: "✓ "; color: #39D97A; font-weight: 700; }
    .btn-primary { display: inline-block; background: linear-gradient(135deg, #F97316, #EA580C); color: #ffffff; padding: 14px 40px; border-radius: 9999px; text-decoration: none; font-weight: 700; font-size: 16px; margin: 8px 0; }
    ...
    @media (prefers-color-scheme: dark) {
      ...
      .benefits { background: #07111F; border-color: #1E314A; }
      .benefits li { color: #94a3b8; }
...
<body>
  <div class="email-wrapper">
    <div class="email-container">
      ...
      <div class="email-content">
        ...
        <p>After completing our review, I'm pleased to let you know that your business has been <strong>approved</strong> for our current <strong>Q3 Growth Support Implementation Initiative</strong>.</p>
        <p>Based on our evaluation, we believe your business has strong growth potential and would benefit from structured implementation across the priority areas identified in your Growth Profile.</p>
        <div class="benefits">
          <p style="font-weight: 700; color: #0B1628; dark-mode-color: #ffffff; margin-bottom: 8px;">As part of this initiative, your business is eligible for:</p>
          <ul>
            <li>Priority implementation scheduling</li>
            <li>A dedicated Growth Consultant</li>
            <li>Structured implementation roadmap</li>
            <li><strong>30% implementation support</strong> on eligible services</li>
          </ul>
        </div>
        <div class="journey-tracker">
          ...
          <div class="journey-steps">
            ...
            <span class="journey-line done"></span>
            <span class="journey-step active"><span class="icon">●</span> Strategy</span>
        ...
        <p>Your Growth Profile explains the opportunities we identified and why they matter.</p>
        <p style="text-align: center; margin: 24px 0;">
          <a href="${data.scheduleUrl}" class="btn-primary">Schedule Strategy Session</a>
        </p>
        <div class="signoff">
  ...
  try {
    ...
    console.log('✅ Approved growth support email sent to:', data.email)
  } catch (error) {
    console.error('Error sending approved growth support email:', error)
  }
}