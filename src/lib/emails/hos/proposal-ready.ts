...
export async function sendProposalReadyEmail(data: EmailData) {
  const html = `
<!DOCTYPE html>
<html>
<head>
  ...
  <title>Proposal Ready - Hbee Digitals</title>
  <style>
...
<body>
  <div class="email-wrapper">
    <div class="email-container">
      <div class="email-header">
        ...
        <div class="badge">Proposal Ready</div>
      </div>
      <div class="email-content">
        <h1>Your Implementation Proposal Is Ready</h1>
        <p>Hi <strong>${data.firstName}</strong>,</p>
        <p>Following our discussions and the findings from your Growth Profile, we've prepared your personalised implementation proposal.</p>
        <p>Your proposal outlines:</p>
        <ul>
          <li>Recommended implementation scope</li>
        ...
        <div class="journey-tracker">
          ...
          <div class="journey-steps">
            ...
            <span class="journey-line done"></span>
            <span class="journey-step active"><span class="icon">●</span> Proposal</span>
            <span class="journey-line"></span>
            <span class="journey-step"><span class="icon">○</span> Onboarding</span>
          </div>
        </div>
        <p style="text-align: center; margin: 24px 0;">
          <a href="${data.proposalUrl}" class="btn-primary">View Your Proposal</a>
        </p>
        <p>If everything looks good, you can accept the proposal directly from your portal to begin onboarding.</p>
        <div class="signoff">
  ...
  try {
    ...
    console.log('✅ Proposal ready email sent to:', data.email)
  } catch (error) {
    console.error('Error sending proposal ready email:', error)
  }
}