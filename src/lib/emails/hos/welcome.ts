...
<head>
  ...
  <title>Welcome to Hbee Digitals</title>
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .portal-features { background: #f8fafc; border: 1px solid #e2e8f0; border-radius: 16px; padding: 20px 24px; margin: 20px 0; }
    .portal-features li { padding: 6px 0; color: #475569; list-style: none; }
    .portal-features li::before { content: "✓ "; color: #39D97A; font-weight: 700; }
    ...
    @media (prefers-color-scheme: dark) {
      ...
      .portal-features { background: #07111F; border-color: #1E314A; }
      .portal-features li { color: #94a3b8; }
    ...
    @media (max-width: 480px) {
      ...
      .btn-primary, .btn-secondary { display: block; text-align: center; padding: 14px 24px; }
...
<body>
  <div class="email-wrapper">
    <div class="email-container">
      ...
      <div class="email-content">
        <h1>Welcome to Hbee Digitals 🎉</h1>
        <p>Hi <strong>${data.firstName}</strong>,</p>
        <p>Welcome to Hbee Digitals.</p>
        <p>We're delighted you've chosen to partner with us.</p>
        <p><strong>Your implementation project has now officially begun.</strong></p>
        <div class="portal-features">
          <p style="font-weight: 700; color: #0B1628; dark-mode-color: #ffffff; margin-bottom: 8px;">Through your Client Portal you'll be able to:</p>
          <ul>
            <li>Track project progress</li>
            <li>View milestones</li>
            <li>Exchange files and messages</li>
        ...
        <div class="journey-tracker">
          ...
          <div class="journey-steps">
            ...
            <span class="journey-line done"></span>
            <span class="journey-step done"><span class="icon">✓</span> Strategy</span>
            <span class="journey-line done"></span>
            <span class="journey-step done"><span class="icon">✓</span> Proposal</span>
            <span class="journey-line done"></span>
            <span class="journey-step active"><span class="icon">●</span> Onboarding</span>
          </div>
        </div>
        <p>The next step is to complete your Client Onboarding so we can gather the remaining information required to begin implementation.</p>
        <p style="text-align: center; margin: 24px 0;">
          <a href="${data.onboardingUrl}" class="btn-primary">Complete Client Onboarding</a>
        </p>
        <p style="text-align: center; margin: 12px 0 24px;">
          <a href="${data.portalUrl}" class="btn-secondary">Open Client Portal</a>
        </p>
        <p>Once your onboarding is complete, your dedicated consultant will review everything and prepare your project for kickoff.</p>
        <p>We're excited to work with you and help your business move toward its next stage of growth.</p>
        <div class="signoff">
  ...
  try {
    await resend.emails.send({
      ...
      to: data.email,
      subject: 'Welcome to Hbee Digitals 🎉',
      html,
    })
