    ...
    <section className="section" style={{ background: 'var(--bg-card-dark)' }}>
      <div className="container-custom">
        ...
        <div className="mt-12 grid gap-4 sm:grid-cols-2 lg:grid-cols-5">
          {pillars.map((pillar, index) => (
            <motion.div
              ...
              className="group relative overflow-hidden rounded-2xl border border-[var(--border)] bg-[var(--bg-page)] p-6 text-center transition-all hover:border-[var(--accent-orange)]"
            >
              <div className="relative z-10">
                <div className="mb-3 flex justify-center">
                  <SvgIcon name={pillar.icon} size={40} color={pillar.color} />
                </div>
              ...
              <div 
                ...
                style={{
                  background: `radial-gradient(circle at center, ${pillar.color}20, transparent 70%)`
                }}
              />
            </motion.div>
          ))}
        ...
        <motion.div
          ...
          className="mt-12 rounded-2xl border border-[var(--border)] bg-[var(--bg-page)] p-8 text-center"
        >
