          ...
          {sortedMembers.map((member, index) => {
            ...
            return (
              <motion.article
                ...
                viewport={{ once: true }}
                className="group relative overflow-hidden rounded-[2rem] border border-[#1E314A] bg-gradient-to-br from-[#0E1B2D] to-[#0B1625] p-5 shadow-[0_28px_80px_rgba(0,0,0,0.22)] transition duration-300 hover:-translate-y-2 hover:border-[#39D97A]/28"
              >
                <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_left,rgba(57,217,122,0.11),transparent_42%)]" />

                <div className="relative">
                  <div className="relative mb-6 h-72 overflow-hidden rounded-[2rem] rounded-br-[4.5rem] border border-[#1E314A] bg-[#07111F] transition duration-500 group-hover:border-[#39D97A]/24 sm:h-80">
                    {imageSrc ? (
                      <Image
                        src={imageSrc}
                        alt={member.name}
                    ...
                    <div className="absolute inset-0 bg-gradient-to-t from-[#07111F]/78 via-[#07111F]/8 to-transparent" />
