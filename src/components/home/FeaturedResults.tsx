        ...
        <div className="grid gap-5 lg:grid-cols-[1.15fr_0.85fr]">
          ...
          >
            <div className="relative min-h-[420px] overflow-hidden rounded-[1.7rem] bg-[#07111F]">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-[#07111F]/92 via-[#07111F]/20 to-transparent" />

              <div className="absolute left-5 top-5 rounded-full bg-[#39D97A] px-4 py-2 text-[11px] font-black uppercase tracking-[0.14em] text-[#06101F]">
                {getMetric(featured)}
              </div>

              {featured.is_before_after && (
                <div className="absolute right-5 top-5 rounded-full border border-white/10 bg-[#07111F]/80 px-4 py-2 text-[11px] font-black uppercase tracking-[0.14em] text-white backdrop-blur-xl">
                  Before / After
                </div>
              )}
              ...
              <div className="absolute bottom-5 left-5 right-5">
                ...
                <h3 className="text-4xl font-black tracking-[-0.05em] text-white">
                  {getTitle(featured)}
                </h3>
            ...
            {sideItems.map((item) => (
              ...
              >
                <div className="relative min-h-[170px] overflow-hidden rounded-[1.35rem] bg-[#07111F]">
                  {getImage(item) ? (
                    ...
                    <div className="flex h-full min-h-[170px] items-center justify-center">
                      <SvgIcon name="portfolio" size={42} color="#39D97A" />
                    </div>
                  )}

                  <div className="absolute left-3 top-3 rounded-full bg-[#39D97A] px-3 py-1.5 text-[10px] font-black uppercase tracking-[0.12em] text-[#06101F]">
                    {getMetric(item)}
                  </div>
                </div>
                ...
                <div className="flex flex-col justify-center p-2">
                  ...
                  <span className="mt-4 inline-flex items-center gap-2 text-sm font-black text-[#39D97A]">
                    View Project
                    <SvgIcon name="arrow-diagonal" size={14} color="#39D97A" />
                  </span>
                </div>
