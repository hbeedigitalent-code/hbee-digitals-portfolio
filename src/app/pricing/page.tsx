          ...
          <div className="mx-auto max-w-7xl">
            {packages.length > 0 ? (
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="relative">
                        ...
                        {item.best_for && (
                          <div className="mt-6 rounded-[1.3rem] border border-[#1E314A] bg-[#07111F] p-4">
                          ...
                          {features.map((feature) => (
                            ...
                            >
                              <span className="mt-0.5 flex h-7 w-7 flex-shrink-0 items-center justify-center rounded-xl border border-[#39D97A]/16 bg-[#39D97A]/10">
                                <SvgIcon name="verified" size={12} color="#39D97A" />
                              </span>
                        ...
                        <Link
                          ...
                          className={`mt-8 inline-flex min-h-[52px] w-full items-center justify-center gap-2 rounded-full px-6 py-3 text-sm font-black transition hover:scale-[1.02] ${
                            item.is_featured
                              ? 'bg-[#39D97A] text-[#06101F] hover:bg-[#C6F135]'
                              : 'border border-[#39D97A]/25 bg-[#39D97A]/10 text-[#39D97A] hover:bg-[#39D97A]/15'
                          }`}
                        >
                          ...
                          <SvgIcon
                            name="arrow-diagonal"
                            size={15}
                            color={item.is_featured ? '#06101F' : '#39D97A'}
                          />
                        </Link>
                      </div>
                    </div>
              ...
              <div className="rounded-[2rem] border border-[#1E314A] bg-[#0E1B2D] px-6 py-16 text-center">
                <SvgIcon name="pricing" size={52} color="#39D97A" />
