          ...
          <div className="mx-auto max-w-7xl">
              ...
              {services.map((service: Service, index: number) => {
                ...
                return (
                  <Link
                    ...
                    className={`group relative overflow-hidden rounded-[2rem] border border-[#1E314A] bg-gradient-to-br from-[#0E1B2D] to-[#0B1625] p-5 transition duration-300 hover:-translate-y-1 hover:border-[#39D97A]/28 hover:shadow-[0_30px_90px_rgba(0,0,0,0.28)] sm:p-6 ${
                  ...
                  >
                    ...
                    <div className="relative">
                      <div className="mb-6 flex h-14 w-14 items-center justify-center rounded-2xl border border-[#39D97A]/18 bg-[#39D97A]/10">
                        <SvgIcon name={icon} size={25} color="#39D97A" />
                      </div>
                      ...
                      <h2 className="text-3xl font-black leading-[1] tracking-[-0.045em] text-white sm:text-4xl">
                        {title}
                      </h2>
                    ...
                    <div className="relative mt-7 grid gap-3 lg:mt-0">
                      {(features.length ? features : benefits.length ? benefits : ['Strategy', 'Execution', 'Optimization']).map((item) => (
                        <div
                          key={item}
                          className="flex items-center gap-3 rounded-2xl border border-[#1E314A] bg-[#07111F]/85 px-4 py-3"
                        >
            ...
            {services.length === 0 && (
              <div className="rounded-[2rem] border border-[#1E314A] bg-[#0E1B2D] px-6 py-16 text-center">
                <SvgIcon name="services" size={52} color="#39D97A" />
