    ...
    async function fetchData() {
      try {
        const [
          ...
          supabase.from('portfolio_items').select('*').eq('is_active', true).eq('featured', true).order('display_order').limit(4)
        ])
              ...
              <Link href={item.url || '/portfolio'}>
                <div className="bg-white rounded-xl overflow-hidden hover:shadow-xl transition-all duration-300 hover:-translate-y-1 border border-gray-100">
                  ...
                  <div className="relative h-44 w-full overflow-hidden bg-gradient-to-br from-gray-100 to-gray-200">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-t from-[#007BFF]/70 via-[#007BFF]/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end justify-center pb-3">
