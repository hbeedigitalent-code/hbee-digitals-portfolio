    ...
    return (
      <main className="min-h-screen text-white">
        <div className="mx-auto max-w-4xl">
          <div className="h-64 animate-pulse rounded-[2rem] border border-[#1E314A] bg-[#0E1B2D]" />
        </div>
      </main>
    )
  }
        ...
        <div className="mb-8 flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
          <div>
            ...
            <p className="mt-3 max-w-2xl text-sm leading-7 text-white/55">
              Update and manage your pricing package information.
            </p>
          </div>
...
SEO improvements`}
          ...
          >
            {saving ? 'Saving Changes...' : 'Update Pricing Package'}
          </button>
        </form>
      </div>
    </main>
