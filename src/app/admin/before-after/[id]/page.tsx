  ...
  return (
    <div className="space-y-6 max-w-4xl">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-bold text-white">Edit Transformation</h1>
        ...
        <div className="ml-auto flex items-center gap-3">
          ...
          <Link
            href={`/before-after`}
            target="_blank"
            className="rounded-full border border-[var(--border)] px-4 py-1.5 text-sm text-[var(--text-muted)] hover:bg-[var(--bg-card-dark)] transition"
          >
            View Live
          </Link>
        </div>
          ...
          <div>
            ...
            <div className="flex gap-2">
              <input
                ...
                value={formData.slug}
                onChange={handleChange}
                className="flex-1 rounded-lg border border-[var(--border)] bg-[var(--bg-page)] px-4 py-2.5 text-white focus:outline-none focus:ring-2 focus:ring-[var(--accent-orange)]"
              />
              <button
                type="button"
          ...
          <div className="flex items-center gap-6 pt-6">
            ...
            <label className="flex items-center gap-2 cursor-pointer">
              <input
                ...
                className="h-4 w-4 rounded border-[var(--border)] bg-[var(--bg-page)] text-[var(--accent-orange)] focus:ring-[var(--accent-orange)]"
              />
              <span className="text-sm text-white">Show in Before/After</span>
            </label>
          </div>
        </div>
